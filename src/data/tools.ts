...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    icon: 'FileCode',
    related: ['python-dataclass-generator', 'json-to-zod', 'json-to-typescript'],
    status: 'live',
    addedAt: '2026-07-26',
  },
  {
    ...
    icon: 'Terminal',
    related: ['postman-to-openapi', 'curl-to-python', 'openapi-to-postman'],
    status: 'live',
    addedAt: '2026-07-26',
  },
  {
    ...
    icon: 'Server',
    related: ['docker-compose-to-kubernetes', 'env-to-docker-compose', 'env-to-k8s-secret'],
    status: 'live',
    addedAt: '2026-07-26',
  },
  {
    ...
    icon: 'Database',
    related: ['sql-to-prisma', 'sql-to-typeorm', 'sql-to-drizzle'],
    status: 'live',
    addedAt: '2026-07-26',
  },
  {
    ...
    icon: 'FileJson',
    related: ['insomnia-to-postman', 'postman-to-openapi', 'openapi-to-postman'],
    status: 'live',
    addedAt: '2026-07-26',
  },
  {
    ...
    icon: 'FileJson',
    related: ['postman-to-insomnia', 'openapi-to-postman', 'postman-to-openapi'],
    status: 'live',
    addedAt: '2026-07-26',
  },
];
